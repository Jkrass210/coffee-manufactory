// answers-tabs.js
export function initAnswersTabs(
  containerSelector = '.box-answers-tabs',
  tabSelector = '.card-answers-tab',
  buttonSelector = '.card-answers-tab__btn',
  contentSelector = '.card-answers-tab__box-info'
) {
